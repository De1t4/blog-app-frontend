...
export const UserCard:React.FC<CardComponent> = ({ title, users, onFollow, updateSearchUser }) => {
  return(
    <>
      <aside className="border-[1px] mt-8 border-slate-600 shadow-md shadow-slate-800 hover:shadow-slate-700 hover:border-slate-300 transition-all duration-300   bg-slate-800 rounded-lg h-max py-4 px-4 text-xl">
